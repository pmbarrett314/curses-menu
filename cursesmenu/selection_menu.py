...
class SelectionMenu(cursesmenu.CursesMenu):
    """
    A menu that simplifies item creation, just give it a list of strings and \
    it builds the menu for you
    """
    ...
    def __init__(self, strings, title=None, subtitle=None, show_exit_option=True):
        ...
        for index, item in enumerate(strings):
            self.append_item(cursesmenu.items.SelectionItem(item, index, self))
    ...
    def get_selection(
        ...
        :param list _menu: should probably only be used for testing, pass \
        in a list and the created menu used
    ...
    def append_string(self, string):
        self.append_item(cursesmenu.items.SelectionItem(string))
